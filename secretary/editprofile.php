<?php
session_start();
$id = $_SESSION['secdetails']['m_id'];
$name= $_SESSION['secdetails']['m_name'];
$mobile=$_SESSION['secdetails']['m_mobile'];
$email=$_SESSION['secdetails']['m_email'];
?>
<?php
...
<?php
    ...
    ?>
            <script>
                ...
                setTimeout(window.location.href = "./secretarylogout.php", 20);
            </script>
    <?php
        } else {
