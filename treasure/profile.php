...
<div class="content">
    <div class="profilecard mt-5">
        ...
        <h1>TREASURE</h1>
        <p>Name : <?php echo $_SESSION['tredetails']['m_name']?></p>
        <p>Email : <?php echo $_SESSION['tredetails']['m_email']?></p>
        <p>Phone Number : <?php echo $_SESSION['tredetails']['m_mobile']?></p>
        ...
        <p><button class="btnedit mt-3" onclick="location.href='./editprofile.php'">Edit Profile</button></p>
    </div>
</div>