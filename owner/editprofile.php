    ...
    <div class="container my-5">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="mobile" onkeyup="validatemobile()" onchange="validatemobile()" class="form-control" id="exampleFormControlInput1" placeholder="Enter Member's Mobile Number : " name="mobile" pattern="[6-9]{1}[0-9]{9}" value="<?php echo $mobile ?>" required>
            </div>
